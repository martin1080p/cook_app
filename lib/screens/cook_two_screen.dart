...
class CookTwo extends StatelessWidget {
  const CookTwo({Key? key, required this.title}) : super(key: key);
                      ...
                      child: Column(
                        children: [
                          ClipRRect(
                            ...
                            child: Image.asset('assets/img/burger.jpeg'),
                          ),
                          Container(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                context.read<IntervalTimer>().endScreen(),
                              ],
                            ),
                          ),
                        ],
